...
#define VECT_FOR_EACH(vec, i) for (int i = 0; i < vec->size; i++)
...
#define VECT_GENERATE_STRUCT(TYPE) \
    typedef struct \
    { \
        int size; \
        int capacity; \
...
#define VECT_GENERATE_FN_DECL(TYPE) VECT_GENERATE_FN_DECL_NAME(TYPE, TYPE)

#define VECT_GENERATE_FN_DECL_NAME(TYPE, NAME) \
